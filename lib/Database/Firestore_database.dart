...
class Repository {
  ...
  Future<QuerySnapshot> getRequiredDocument(
      String collectionName, String whereAttribute, String isEqualTo) async {
    return await Firestore.instance
        .collection(collectionName)
        .where(whereAttribute, isEqualTo: isEqualTo)
        .getDocuments();
  }
  ...
  Future<void> createCommentDocument(
      Map<String, dynamic> mapCommentDocument) async {
